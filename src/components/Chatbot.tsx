...
export function Chatbot() {
  ...
  setIsTyping(true);
    ...
    // 🟢 Hide typing indicator once reply arrives
  setIsTyping(false);
  ...
  >
    <div className="bg-gradient-to-br from-blue-50 to-purple-50 text-gray-800 border border-blue-100 px-3 py-2 rounded-2xl flex items-center gap-2">
